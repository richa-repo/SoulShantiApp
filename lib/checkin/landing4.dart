...
import 'package:navigation/checkin/landing5.dart';

import '../navigator/navigation.dart';
import 'landing2.dart';
import 'landing3.dart';

class CheckInPage4 extends StatefulWidget {
  @override
  _CheckInPageState createState() => _CheckInPageState();
}

class _CheckInPageState extends State<CheckInPage4> {
  int currentStep = 4;
            ...
            child: Column(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    buildOptionButton('Very often'),
                    SizedBox(height: 16),
                    buildOptionButton('Fairly often'),
                    SizedBox(height: 16),
                    buildOptionButton('Sometimes'),
                    SizedBox(height: 16),
                    buildOptionButton('Almost never'),
                    SizedBox(height: 16),
                    buildOptionButton('Never'),
                    SizedBox(height: 16),
                  ],
                ),
              ],
