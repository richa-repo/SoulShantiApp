...
import 'package:navigation/checkin/landing7.dart';
...
class CheckInPage6 extends StatefulWidget {
  @override
  _CheckInPageState createState() => _CheckInPageState();
}

class _CheckInPageState extends State<CheckInPage6> {
  int currentStep = 6;
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text(
                  'Over the last two weeks, how often have you been bothered by any of the following problems? Feeling nervous, anxious or on edge.',
                  style: GoogleFonts.montserrat(
                    fontSize: 15,
                    color: Colors.white,
                    fontWeight: FontWeight.bold,
