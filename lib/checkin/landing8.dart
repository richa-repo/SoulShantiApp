...
import 'package:navigation/checkin/landing9.dart';
...
class CheckInPage8 extends StatefulWidget {
  @override
  _CheckInPageState createState() => _CheckInPageState();
}

class _CheckInPageState extends State<CheckInPage8> {
  int currentStep = 8;
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text(
                  'Over the last two weeks, how often have you been bothered by any of the following problems? Worrying too much about different things.?',
                  style: GoogleFonts.montserrat(
                    fontSize: 15,
                    color: Colors.white,
                    fontWeight: FontWeight.bold,
