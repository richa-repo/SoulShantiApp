...
import 'landing10.dart';
import 'landing2.dart';
import 'landing3.dart';
import 'landing4.dart';

class CheckInPage9 extends StatefulWidget {
  @override
  _CheckInPageState createState() => _CheckInPageState();
}

class _CheckInPageState extends State<CheckInPage9> {
  int currentStep = 9;
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text(
                  'Over the last two weeks, how often have you been bothered by any of the following problems? Trouble relaxing.',
                  style: GoogleFonts.montserrat(
                    fontSize: 15,
                    color: Colors.white,
                    fontWeight: FontWeight.bold,
